//
//  OrganizationMapShowRouter.swift
//  OmnieCommerceAdmin
//
...
protocol OrganizationMapShowRouterInput {
    func navigateToSomewhere()
}

class OrganizationMapShowRouter: OrganizationMapShowRouterInput {
    // MARK: - Properties
    weak var viewController: OrganizationMapShowViewController!
